...
public class FXMLConfiguracionController implements Initializable, ControladorUsuario
{
    ...
    @FXML
    private JFXButton btCambiar;
    @FXML
    private JFXTextField tfUsuario;
    @FXML
    private JFXPasswordField pfActual;
    @FXML
    private JFXPasswordField pfNueva;
    @FXML
    private JFXPasswordField pfNuevaConfirmar;
    @FXML
